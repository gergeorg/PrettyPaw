...
const creareArrow = (className = "arrow-up", { hover = true } = {}) => {
  ...
  .${className} {
     position: fixed;
      ...
      width: 50px;
      height: 50px;
      box-shadow: 0 4px 4px rgb(49 33 1 / 15%);
      color: #000000;
      background-color: #ffffff;

      cursor: pointer;
      opacity: 0.5;
      ${hover && "transition: opacity 0.3s ease-in-out;"}
    }
...
export const scrollToTop = (className, hover) => {
  const arrow = creareArrow(className, hover);
